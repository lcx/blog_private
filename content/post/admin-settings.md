...
description: ""
draft: true
image: https://static.ghost.org/v2.0.0/images/admin-settings.jpg
slug: admin-settings
summary: 'There are a couple of things to do next while you''re getting set up: making
  your site private and inviting your team.'
tags:
- Getting Started
...
You can toggle this preference on at the bottom of Ghost's [General Settings](__GHOST_URL__/ghost/settings/general/):
...
Next up: [Organising your content](__GHOST_URL__/organising-content/) 
